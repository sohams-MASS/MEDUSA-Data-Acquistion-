    ...
    class Program
    {
        ...
        static int SetupCounterAndTimer(INodeMap nodeMap)
        {
            ...
            try
            {
                ...
                if (!counterSelector.IsAvailable)
                {
                ...
                if (!counter0.IsAvailable || !counter0.IsReadable)
                {
                ...
                if (!counterEventSourceMhzTick.IsAvailable || !counterEventSourceMhzTick.IsReadable)
                {
                ...
                if (!counterDuration.IsAvailable || !counterDuration.IsWritable)
                {
                ...
                if (!counterDelay.IsAvailable || !counterDelay.IsWritable)
                {
                ...
                if (!counterTriggerSourceFTW.IsAvailable || !counterTriggerSourceFTW.IsReadable)
                {
                ...
                if (!counterTriggerActivationLH.IsAvailable || !counterTriggerActivationLH.IsReadable)
                {
        ...
        static int ConfigureDigitalIO(INodeMap nodeMap)
        {
            ...
            try
            {
                ...
                if (!deviceModelName.IsAvailable || !deviceModelName.IsReadable)
                {
                ...
                if (!lineSelector.IsAvailable || !lineSelector.IsWritable)
                {
                ...
                if (cameraModel.Contains(cameraFamilyBFS))
                {
                    ...
                    if (!lineSelectorLine1.IsAvailable || !lineSelectorLine1.IsReadable)
                    {
                ...
                else if (cameraModel.Contains(cameraFamilyOryx))
                {
                    ...
                    if (!lineSelectorLine2.IsAvailable || !lineSelectorLine2.IsReadable)
                    {
                        Console.WriteLine("Unable to set Line Selector (entry retrieval). Aborting...");
                        return -1;
                    }
                    ...
                    if (!lineMode.IsAvailable || !lineMode.IsWritable)
                    {
                    ...
                    if (!lineModeOutput.IsAvailable || !lineModeOutput.IsReadable)
                    {
                ...
                if (!lineSource.IsAvailable || !lineSource.IsWritable)
                {
                ...
                if (!lineSourceCounter0Active.IsAvailable || !lineSourceCounter0Active.IsReadable)
                {
                ...
                if (cameraModel.Contains(cameraFamilyBFS))
                {
                    ...
                    if (!voltageEnable.IsAvailable || !voltageEnable.IsWritable)
                    {
        ...
        static int ConfigureExposureAndTrigger(INodeMap nodeMap)
        {
            ...
            try
            {
                ...
                if (!exposureAuto.IsAvailable || !exposureAuto.IsWritable)
                {
                ...
                if (!exposureAutoOff.IsAvailable || !exposureAutoOff.IsReadable)
                {
                    Console.WriteLine("Unable to set Exposure Auto (entry retrieval). Aborting...");
                    return -1;
                }
                ...
                if (!exposureTime.IsAvailable || !exposureTime.IsWritable)
                {
                ...
                if (triggerMode == null || !triggerMode.IsWritable)
                {
                ...
                if (triggerSource == null || !triggerSource.IsWritable)
                {
                ...
                {
                    Console.WriteLine("Unable to set trigger mode (entry retrieval). Aborting...");
                    return -1;
                }
                ...
                if (triggerOverlap == null || !triggerOverlap.IsWritable)
                {
                ...
                {
                    Console.WriteLine("Unable to set trigger overlap (entry retrieval). Aborting...");
                    return -1;
                }
