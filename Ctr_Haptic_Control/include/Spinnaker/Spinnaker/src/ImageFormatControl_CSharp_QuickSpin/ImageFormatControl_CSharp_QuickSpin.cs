    ...
    class Program
    {
        ...
        int ConfigureCustomImageSettings(IManagedCamera cam)
        {
            ...
            try
            {
                ...
                //
                if (cam.OffsetX != null && cam.OffsetX.IsWritable)
                {
                ...
                //
                if (cam.OffsetY != null && cam.OffsetY.IsWritable)
                {
                ...
                //
                if (cam.Width != null && cam.Width.IsWritable)
                {
                ...
                //
                if (cam.Height != null && cam.Height.IsWritable)
                {
