    ...
    class Program
    {
        ...
        int ConfigureLookupTables(INodeMap nodeMap)
        {
            ...
            try
            {
                ...
                if (iLUTSelector == null || !iLUTSelector.IsWritable)
                {
                ...
                if (iLUTSelectorLUT1 == null || !iLUTSelector.IsReadable)
                {
                ...
                if (iLUTValue == null || !iLUTValue.IsWritable)
                {
                ...
                if (iLUTEnable == null || !iLUTEnable.IsReadable)
                {
                    ...
                    try
                    {
                        ...
                        using(IManagedImage rawImage = cam.GetNextImage(1000))
                        {
                            ...
                            else
                            {
                                ...
                                using(IManagedImage convertedImage = rawImage.Convert(PixelFormatEnums.BGRa8))
                                {
